...
void LogInUser(List *ls, coffee_list *menu)
{
    ...
    if (compare == 1)
    {
        ...
        while (true)
        {
            ...
            display(menu);
            cout << "\t\t\t\tEnter drink ID to order: ";
            cin >> coffee_id;
            while (coffee_id != checkID->CoID)
            {
                if (checkID->next == NULL)
                {
                    cout << "\n\t\t\t\tAttention, Invalid coffeeID! Please enter coffee ID again to order: ";
                    cin >> coffee_id;
                    checkID = menu->head;
                    continue;
                }
            ...
            cout << "\tPress 1 to confirm or press 2 to cancel order: ";
            cin >> ff;
            Sleep(500);
            system("CLS");
            if (ff == 1)
            {
                ...
                bestSellInsertBegin(bestsell, coffee_id, qunt);
                displayBestSell(bestsell);
            ...
            else
            {
                ...
                cout << "\n\t\t#### Thank you for ordering our drinks ####\n";
                int sus;
                cout << "\t\t\tPress any number to go back to costumer panel: ";
                cin >> sus;
                break;
            }
        }
